...
public class CookbookAssert extends AbstractAssert<CookbookAssert, CookbookEntity> {

	private CookbookAssert(CookbookEntity actual) {
		super(actual, CookbookAssert.class);
	}
	
	public static CookbookAssert assertThat(CookbookEntity actual) {
