...
public class ShoppingListPersistenceMapperTest {
	
	private ShoppingListPersistenceMapper shoppingListMapper;

	@Test
	public void testMap_toShoppingListTO() throws Exception {
		shoppingListMapper = new ShoppingListPersistenceMapper(new ShoppingListItemMapper());
