...
class HouseholdEventHandlerTest {
    ...
    public void testOnInvitationAccepted_noExistingHousehold() throws Exception {
        ...
        HouseholdServiceEventHandler HouseholdEventHandler = new HouseholdServiceEventHandler(HouseholdService, mock(MessageChannel.class), mock(MessageChannel.class));
