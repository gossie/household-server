...
public class FoodPlanServiceTest {
	...
	public void testGetFoodPlan() throws Exception {
		...
		when(foodPlanRepository.findOne(1L)).thenReturn(expected);
	...
	public void testUpdate() throws Exception {
		...
		FoodPlanRepository foodPlanRepository = mock(FoodPlanRepository.class);
		when(foodPlanRepository.findOne(1L)).thenReturn(saved);
		when(foodPlanRepository.save(saved)).thenReturn(expected);
	...
	public void testClear() throws Exception {
		...
		FoodPlanRepository foodPlanRepository = mock(FoodPlanRepository.class);
		when(foodPlanRepository.findOne(1L)).thenReturn(foodPlan);
		when(foodPlanRepository.save(foodPlan)).thenReturn(expected);
